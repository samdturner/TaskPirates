...
ActiveRecord::Base.transaction do
  ...
  jack_the_monkey = Sailor.create!(name: "Jack the monkey",
                    task_requirement: "none",
  ...
  james_norrington = Sailor.create!(name: "Jame Norrington",
                    task_requirement: "none",
                    image_url: "http://i.imgur.com/PCIJktQ.jpg?1")

  voyage1 = Voyage.create!(user_id: jack.id, sailor_id: davy_jones.id,
                          task_requirement: "car",
  ...
  voyage6 = Voyage.create!(user_id: jack.id, sailor_id: joshamee_gibbs.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
  ...
  voyage7 = Voyage.create!(user_id: jack.id, sailor_id: joshamee_gibbs.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
  ...
  voyage8 = Voyage.create!(user_id: jack.id, sailor_id: joshamee_gibbs.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 1,
  ...
  voyage9 = Voyage.create!(user_id: jack.id, sailor_id: joshamee_gibbs.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
  ...
  voyage10 = Voyage.create!(user_id: jack.id, sailor_id: joshamee_gibbs.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 1,
  ...
  voyage11 = Voyage.create!(user_id: jack.id, sailor_id: ragetti.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 1,
  ...
  voyage12 = Voyage.create!(user_id: jack.id, sailor_id: ragetti.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
                          comment: "He was on time, professional and
  ...
  voyage13 = Voyage.create!(user_id: jack.id, sailor_id: ragetti.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage14 = Voyage.create!(user_id: jack.id, sailor_id: ragetti.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 1,
  ...
  voyage15 = Voyage.create!(user_id: jack.id, sailor_id: ragetti.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage16 = Voyage.create!(user_id: jack.id, sailor_id: cotton.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage17 = Voyage.create!(user_id: jack.id, sailor_id: cotton.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
  ...
  voyage18 = Voyage.create!(user_id: jack.id, sailor_id: cotton.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
  ...
  voyage19 = Voyage.create!(user_id: jack.id, sailor_id: cotton.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
  ...
  voyage20 = Voyage.create!(user_id: jack.id, sailor_id: cotton.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage21 = Voyage.create!(user_id: jack.id, sailor_id: jack_the_monkey.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage22 = Voyage.create!(user_id: jack.id, sailor_id: jack_the_monkey.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage23 = Voyage.create!(user_id: jack.id, sailor_id: jack_the_monkey.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
  ...
  voyage24 = Voyage.create!(user_id: jack.id, sailor_id: jack_the_monkey.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage25 = Voyage.create!(user_id: jack.id, sailor_id: jack_the_monkey.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 2,
  ...
  voyage26 = Voyage.create!(user_id: jack.id, sailor_id: murtogg.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 2,
  ...
  voyage27 = Voyage.create!(user_id: jack.id, sailor_id: murtogg.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 1,
  ...
  voyage28 = Voyage.create!(user_id: jack.id, sailor_id: murtogg.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 2,
  ...
  voyage29 = Voyage.create!(user_id: jack.id, sailor_id: marty.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 4,
  ...
  voyage30 = Voyage.create!(user_id: jack.id, sailor_id: marty.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
  ...
  voyage31 = Voyage.create!(user_id: jack.id, sailor_id: marty.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
  ...
  voyage32 = Voyage.create!(user_id: jack.id, sailor_id: anamaria.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 3,
  ...
  voyage33 = Voyage.create!(user_id: jack.id, sailor_id: anamaria.id,
                          task_requirement: "car",
                          start_date: Date.new(2015, 04, 14),
                          end_date: Date.new(2015, 04, 16), rating: 5,
